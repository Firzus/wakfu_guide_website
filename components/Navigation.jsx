...
const Navigation = () => {
    ...
    return (
        <header className='flex justify-between items-center bg-black-900'>
            <Link href={linkHome}>
                <Image
                    className='mx-2 laptop:mx-6 w-8 laptop:w-12 h-12 laptop:h-20'
                    src={Logo}
                    alt='Wakfu Guide Logo'
                />
            </Link>

            <li className='hidden laptop:flex ml-24 mr-auto gap-12'>
            ...
            <div
                ...
                className='flex laptop:hidden w-12 h-12'
            >
                <Image
                    className='mx-auto'
                    src={IconDropdown}
            ...
            <ul className='hidden laptop:flex gap-8 pr-6'>
